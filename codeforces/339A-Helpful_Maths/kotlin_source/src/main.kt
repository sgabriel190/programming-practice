 ...
 * It only contains digits and characters "+". Besides, string s is a correct sum of numbers 1, 2 and 3. String s is at
 ...
 */
fun main(){
    val listOfNumbers = readLine()!!.split("+")
    val listOfNumbersSorted = listOfNumbers.sorted()

    println(listOfNumbersSorted.joinToString(separator = "+"))
